 ...
 */
package org.bspv.gateway.config;
...
public class SecurityConfig {
    ...
    public static final String DEFAULT_LOGIN_ENDPOINT_PATH = "/login";

    private static final ServerWebExchangeMatcher LOGIN_MATCHER = new PathPatternParserServerWebExchangeMatcher(
            DEFAULT_LOGIN_ENDPOINT_PATH, HttpMethod.POST);

    public static final String DEFAULT_ACCESS_TOKEN_COOKIE_NAME = "BSPV-ACCESS";
    ...
    SecurityWebFilterChain springSecurityFilterChain(final ServerHttpSecurity http) {
        ...
        return http
            ...
            .authorizeExchange()
                ...
                .matchers(LOGIN_MATCHER).permitAll()
